...
function RegularPrint({ request }) {
 ...
 const detailRow = (label, value) => (
  ...
  const renderCopy = (copyTitle, showSecurityFields) => (
    <section className="copy-section regular-print-copy border-2 border-black flex flex-col p-4 relative">
      ...
      <div className="grid grid-cols-2 gap-14 border-b border-black py-3">
        <div>
          ...
          {detailRow("Vehicle No", request.vehicleNumber)}
        </div>
        ...
        <div>
          ...
          {detailRow("Category", request.category)}
        </div>
      </div>
